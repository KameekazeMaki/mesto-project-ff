...
const cardsContainer = content.querySelector('.places__list');//создали переменную placesList - доступ к элементу с классом .places__list внутри найденной content(index.js)
...
initialCards.forEach(card =>  { 
  cardsContainer.append(createCard(card, deleteCard, cardLike, openImage));
});
...
formNewCard.addEventListener('submit', function(evt) {
  ...
  evt.preventDefault();
  cardsContainer.prepend(createCard(card, deleteCard, cardLike, openImage));
  formNewCard.reset();
